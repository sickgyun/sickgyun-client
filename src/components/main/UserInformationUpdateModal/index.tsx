...
const UserInformationUpdateModal = ({ isOpen, onClose }: UserInformationUpdateModalProps) => {
  ...
  const onUpdateUserInformationSubmit: SubmitHandler<UserInformationUpdateFormInput> = data => {
