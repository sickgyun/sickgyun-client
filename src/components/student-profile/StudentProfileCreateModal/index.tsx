...
const StudentProfileCreateModal = ({ isOpen, onClose }: StudentProfileCreateModalProps) => {
  ...
  const onCreateStudentProfileSubmit: SubmitHandler<StudentProfileCreateFormInput> = data => {
      ...
      >
        ...
        <ModalBody>
          <Flex flexDirection="column" gap="16px">
            <Flex gap="8px">
              <Input value={userInformation.name} placeholder="이름을 입력해주세요." disabled />
              <Input
