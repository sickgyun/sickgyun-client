...
const DEVELOPMENT_API_URL = 'https://port-0-connect-server-v1-iad5e2alq0cm0ff.sel4.cloudtype.app/';
const PRODUCTION_API_URL = 'https://port-0-connect-server-v1-iad5e2alq0cm0ff.sel4.cloudtype.app/';
